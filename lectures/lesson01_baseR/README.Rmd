...
Name: `r family[3]` Age: `r age[3]`
 ...
 - Read carefully the documentation for `is.vector()`. If `is.vector(x)` retrieves `TRUE`, does it mean that `x` is an atomic vector? No, it may return true when mode is 
