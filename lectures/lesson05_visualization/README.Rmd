...
ggplot(data = dt, aes(x=College, fill= Sex)) +
  geom_bar(position = 'dodge') +       #plot a count of students in each college
...
ggplot(data = dt, aes(x=Ethnicity, fill= Sex)) +
...
ggplot(data = dt) +
  ...
  scale_fill_manual(values  = c("636363", "897777", "656565"))
